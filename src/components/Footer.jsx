            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 min-[1130px]:grid-cols-12 gap-8 lg:gap-0 pb-14 border-b-2 border-gray-200">
                    <div className="min-[1130px]:col-span-5 col-span-1 w-full min-[1130px]:max-w-full mx-auto">
                        <div className="flex flex-col max-sm:items-center gap-8 w-full ">
                            <NavLink to={"https://pagedone.io/"} className="py-1.5 ">
                ...
                <div className="flex flex-col-reverse gap-5 md:flex-row items-center first-letter:items-center justify-between pt-7">
                    ...
                    <ul className="flex items-center gap-9">
                        ...
                        <li><NavLink to={"javascript:;"}
                            className="text-white text-sm font-normal transition-all duration-300 hover:text-indigo-600 focus-within:text-indigo-600 focus-within:outline-0">Privacy</NavLink>
                        </li>
                        <li><NavLink to={"javascript:;"}
                            className="text-white text-sm font-normal transition-all duration-300 hover:text-indigo-600 focus-within:text-indigo-600 focus-within:outline-0">Cookies</NavLink>
                        </li>
                    </ul>
